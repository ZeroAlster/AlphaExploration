...
import argparse
from DDPG_temporal.ddpg_temporal import Agent
...
def main(address,environment,option_length):
    ...
    # initiate the agent
    agent=Agent(num_actions,num_states,action_range,threshold,option_length)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l','--option_length',required=True)
    ...
    if args.task=="train":
        main(args.address,args.environment,int(args.option_length))
    elif args.task=="plot":
