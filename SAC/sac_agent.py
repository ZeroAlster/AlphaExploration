...
class CustomCallback(BaseCallback):
    ...
    """
    def __init__(self,address, verbose=0,checkpoint=10000,episode_length=100):
    ...
    def _on_step(self) -> bool:
        ...
        if self.num_timesteps % self.len_episode== self.len_episode-1:
            ...
            if math.sqrt(math.pow(self.locals["new_obs"][0][0]-8.8503,2)+math.pow(self.locals["new_obs"][0][1]-9.1610,2))<=0.15:
                self.success+=1
                print("hooora!!!!")
