...
lines = ax.plot(range(10), colors[0], range(10), colors[1], range(10), colors[2], range(10), colors[3],range(10), colors[4],range(10), colors[5],range(10), colors[6])
figlegend.legend(lines, ("DDPG","ETGL-DDPG (perfect model)","ETGL-DDPG (replay buffer)" ,"DDPG + HER","DDPG + \u03B5z-greedy","DDPG + intrinsic motivation ", "SAC"),loc='center',ncol=7)
fig.show()
figlegend.show()
...
# success6=[]
# success7=[]
# address1="DDPG/results/push"
# address2="our_method/results/push/full (perfect model)"
# address3="our_method/results/push/full (replay buffer)"
# address4="DDPG_HER/results/push"
# address5="DDPG_ICM/results/push"
# address6="DDPG_temporal/results/push"
# address7="SAC/results/push"
...
#         if i!=0 and i!=2 and i!=5 and i!=4 and i!=9:
...
# address2="our_method/results/push/full (perfect model)"
# address3="our_method/results/push/full (replay buffer)"
# address4="DDPG/results/push"
# address5="DDPG/results/"
...
for  i in range(num_agent):
    with open("DDPG_temporal/results/push/agent"+str(i+1)+"/locations", 'rb') as fp:
